...
7. [ ] Open WebUI builtin_tools und code_interpreter wurden deaktiviert (SQLite-Edit). Falls builtin-Tools wieder benötigt werden, müssen die capabilities in der model-Tabelle reaktiviert werden.