...
2. [ ] **UI-Verifikation Open WebUI Web Search durch Georg selbst machen** (qwen3:8b-search, Globe-Icon): API-e2e lief, echter UI-Durchlauf (Chat speichern, Zitaten-UI) noch nicht von mir getestet.
