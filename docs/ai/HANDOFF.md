...
Agenten-Test X0/X1/X2 abgeschlossen (Harness + Rohdaten in `/tmp/opencode/exp/`, nicht git): Default-Agent `ollama-direct/qwen3:8b-24k`, Large-Window-Agent `qwen3.5:4b-64k`; Details und Scores in STATE.md.
