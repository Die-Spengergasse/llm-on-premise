...
| 2026-07-05 | LiteLLM (Docker, bundled Postgres 16, `api_base`=gregors WireGuard-IP `10.8.0.18`) als zentraler Gateway statt Custom-FastAPI-Proxy — wegen Virtual-Keys/Budgets/Rate-Limits und Skalierung auf hunderte User. `:main-stable` akzeptiert kein SQLite mehr (PITFALLS). | Beschlossen |
